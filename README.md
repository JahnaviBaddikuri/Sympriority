...
Speech to Text integration – openai/whisper-medium

Triage LLM – mistralai/Ministral-3-3B-Instruct-2512 

Gradio  – Used to build an interactive web interface for voice/text input and real-time output display

Backend - Python

Frontend – HTML CSS

Runtime – Google Colob (free tier)
